...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{gemini3vs2.5flash.png}
    \caption{Performance comparison between Gemini 3 Flash and Gemini 2.5 Flash across all evaluation metrics.}
    \label{fig:gemini-comparison}
\end{figure}
