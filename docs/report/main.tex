...
\author{
    ...
    Ignasi Cervero\\
    \texttt{ignasi.cervero@estudiantat.upc.edu}\\[0.5em]
...
The source code is available at \url{https://github.com/akossch0/upc-fib-agent}.
\end{abstract}
